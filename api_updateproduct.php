...
if(isset($_REQUEST['product_name']) && isset($_REQUEST['product_desc']) && isset($_REQUEST['product_price']) && isset($_REQUEST['product_discount']) &&isset($_REQUEST['category_id']) && isset($_REQUEST['product_id'])){
    try{
	    $response=array();
	    ...
	    $data=$dbproduct->UpdateProduct($details);
	    if($data!=NULL){
